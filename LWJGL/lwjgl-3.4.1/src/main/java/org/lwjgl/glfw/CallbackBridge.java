...
public class CallbackBridge {
    ...
    // --- SDL launcher integration (used by org.lwjgl.sdl bindings) ---
    // Mirrors AAMC's CallbackBridge notifyLauncher constants. The runtime implementation is
    // provided by the launcher app's CallbackBridge override (see phase 2 SDL support).
    public static final int SDL = 0;  // NOTIF_TYPE_SDL
    public static final int INIT = 0; // ACTION_INIT_LAUNCHER_INTEGRATION
